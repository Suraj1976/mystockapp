...
let ClientsController = class ClientsController {
    ...
    async getMyClients(req) {
        return this.clientsService.findByCreator(req.user.userId);
    }
    async selfRenew(req, renewClientDto) {
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)('SALES_STAFF'),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ClientsController.prototype, "getMyClients", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ClientsController.prototype, "selfRenew", null);
__decorate([
    (0, common_1.Put)(':id'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)('SALES_STAFF'),
