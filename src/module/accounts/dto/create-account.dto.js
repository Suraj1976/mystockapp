...
__decorate([
    (0, class_validator_1.IsMongoId)({ message: 'Package must be a valid MongoDB ID' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'Package is required' }),
    __metadata("design:type", String)
], CreateAccountDto.prototype, "package", void 0);
